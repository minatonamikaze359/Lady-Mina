...
async function audioEffect(m, conn, effectName) {
  ...
  if (!set) throw `❌ *Effect not found, sweetie!*`
  if (!/audio/.test(mime)) throw `❗ *Reply to an audio file or VN with the command, sweetie!*`
  ...
  await conn.sendMessage(m.chat, { audio: result, mimetype: 'audio/mpeg', ptt: false, caption: '🌟 *Powered by Lady-Mina | Owner: Omegatech-01 | Support: https://github.com/Omegatech-01*' }, { quoted: m })
  await unlink(media)
